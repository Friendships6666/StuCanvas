...
namespace GeoFactory {
    ...
    uint32_t CreateVerticalLine(GeometryGraph &graph, uint32_t p1_id, uint32_t p2_id,
                                const GeoNode::VisualConfig &config);

    uint32_t CreateParallelLine(GeometryGraph &graph, uint32_t p1_id, uint32_t p2_id,
                                const GeoNode::VisualConfig &config);
} // namespace GeoFactory
