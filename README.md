...
|:-----------------------------------------------------------------------------------------------:| :--- | :--- |:-----------------------------------------------------------------|
|       <br><img src="./docs/logos/Vulkan_RGB_Dec16.svg" height="70" alt="Vulkan"><br><br>        | **Vulkan SDK** | Apache 2.0 | 现代低开销、跨平台的图形与计算 API，用于构建高性能多线程渲染管线。                              |
|     <br><img src="./docs/logos/nvidia-logo-vert-wht.png" height="75" alt="NVIDIA"><br><br>      | **NVIDIA Driver API** | Proprietary | 结合 CUDA 技术，实现极低开销的显存就地编码（In-place VRAM Encoding）以及视频导出硬件加速。 <br> |
